...
rows_chocolate = int(input("Введите количество рядов в шоколадке: "))
columns_chocolate = int(input("Введите количество столбцов в шоколадке: "))
broken_pieces = int(input("Введите количество долек, которое хотите отломать: "))
